(function(){
  ...
  */
  ...
  var felipe = new Person('Felipe', 'Andrade', 18);
  var maria = new Person('Maria', 'Aparecida', 40);
  var joao = new Person('João', 'Victor', 12);
  console.log(felipe);
  console.log(maria);
  console.log(joao);
  ...
  */
  ...
  console.log(felipe.getFullName() + ' agora tem ' + felipe.addAge(3).getAge() + ' anos.');
  console.log(maria.getFullName() + ' agora tem ' + maria.addAge(10).getAge() + ' anos.');
  console.log(joao.getFullName() + ' agora tem ' + joao.addAge(6).getAge() + ' anos.');
})();